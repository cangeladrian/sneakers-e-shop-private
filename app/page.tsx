...
import { ExclusiveGallery } from '@/app/ExclusiveGallery';
      ...
      <nav className={`fixed top-0 left-0 w-full z-[130] flex justify-between items-center px-12 py-4 transition-all duration-500 ${
        ...
        <div className="flex-1">
          <button 
            ...
            className="relative z-[140] text-xs font-bold uppercase tracking-[0.3em] hover:opacity-50 transition"
          >
        ...
        <div className="flex-none">
          <img 
            src="/logo.png" 
            alt="logo" 
            className={`w-10 h-auto transition-all duration-500 ${isScrolled && !isMenuOpen ? '' : ''}`} 
          />
        </div>

        <div className="flex-1 flex justify-end gap-10 uppercase text-xs font-bold items-center">
...
>
  <button>Košík</button>
  <span className="ml-2 px-2 py-0.5 rounded-full text-[10px] bg-black text-white group-hover:scale-110 transition">0</span>
</div>
        </div>
      </nav>
...
<AnimatePresence>
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#F3F3F3] overflow-hidden">
          ...
          <motion.div 
            animate={isMenuOpen ? { x: mousePos.x * 20, y: mousePos.y * 20 } : { x: 0, y: 0 }}
            transition={{ type: 'tween', ease: 'linear', duration: 0.2 }}
        ...
        <div className="relative h-full container mx-auto px-12 flex items-center justify-end">
          <div className="flex flex-col items-start space-y-4 md:space-y-8 pr-10 md:pr-20">
  ...
  <div className="relative w-full h-auto flex items-center justify-center">
    ...
    {/* 1. VRSTVA: VIDEO (Dole) */}
    <video 
      src="Úprava_videa_s_teniskami.mp4" 
      autoPlay
      loop
      muted 
      playsInline
      className="w-full h-auto drop-shadow-2xl object-cover z-0" 
    />

    {/* 2. VRSTVA: NÁPIS (Hore na videu) */}
    {/* Používame absolute inset-0 na vycentrovanie nad video */}
    <div className="absolute inset-0 flex items-center justify-left ml-50 mt-120 z-20 pointer-events-none">
      <h1 className="text-[1vw] font-normal text-white leading-none select-none drop-shadow-md">
  ...
  <div className="flex flex-row gap-60 items-start text-[18px]  font-normal text-black-800">
  ...
  <br />
      ...
      <section className="max-w-7xl mx-auto px-6 pt-25">
        <div className="flex justify-between items-end mb-16">
          <h2 className="text-[30px] font-bold  uppercase leading-tight ">
...
<br />
      ...
      <section className="relative w-full h-[600px] md:h-[800px] mt-0 mb-0 flex items-center overflow-hidden ">
  ...
  <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10 w-full">
    <div className="grid grid-cols-1 md:grid-cols-12 items-center w-full">
      ...
      <div className="md:col-span-9 md:col-start-8">
        <h1 
          className=" md:text-[20px] lg:text-[60px] font-light text-white leading-[0.85]   "
        >
          Urban classic
          <br /> 
      ...
      <div className="md:col-span-4 md:col-start-1 mt-10 space-y-6">
...
<br />
 ...
 <section className='w-full h-auto flex items-center justify-center mt-25 mb-0 text-5 overflow-hidden'>
    <h1 className='font-light text-[100px] text-center '>NAŠA <br />
    LEGENDA
    </h1>
  ...
  <section className="relative w-full min-h-screen bg-white overflow-hidden mb-50 mt-0 flex items-center justify-center">
      
      {/* 1. VRSTVA: POZADIE (z-0) */}
      <div className="absolute inset-0 z-0">
        <Image src="/group.png" alt="Background" fill className="object-cover opacity-80" />
...
<div className="absolute inset-0 flex items-start justify-center z-10 pointer-events-none">
  <motion.h1 
    ...
    // STYLOVANIE (Triedy)
    className="lg:text-[590px] text-[120px] font-semibold tracking-[-0.08em] text-black leading-none"
  >
    PRO2
  </motion.h1>
</div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-30 pointer-events-none">
        ...
        {/* Topánka */}
        <div className="relative w-[80%] md:w-[600px] lg:w-[1300px] aspect-video transform translate-y-10 m-12 z-50 lg:translate-y-20">
          <Image src="/pro3.png" alt="Topánka" fill className="object-contain" priority />
        </div>

        {/* Kocka (Pedestál) */}
        <div className="relative w-[90%] md:w-[400px] lg:w-[950px]  aspect-square mt-[-65%] md:mt-[-250px] lg:mt-[-350px] mb-15 ml-52 z-20">
      ...
      <div className="container mx-auto px-4 relative z-50 h-screen grid grid-cols-12 gap-5 items-end pb-20 pointer-events-none">
         ...
         <div className='col-start-1 col-span-2 pointer-events-auto flex items-center justify-center'> 

</div>


        {/* Tlačidlo Objav */}
        <div className="col-start-6 col-span-2 pointer-events-auto">
          <button className="bg-black text-[13px] text-white px-6 py-3 font-bold  hover:invert transition-all">
            Objav
          </button>
        </div>
        ...
        {/* Popisy vpravo */}
       <div className="col-start-10 col-span-3 text-right pointer-events-auto  flex flex-col items-end">
  ...
  <div className="flex flex-col items-end">
    <HandwrittenNote 
      text="6mm Flat-waxed" 
      delay={2.5} 
      className="text-3xl md:text-4xl text-neutral-800 leading-tight" 
    />
    <HandwrittenNote 
      text="Cotton Laces" 
      delay={3.2} 
...
<section className='w-full bg-black flex flex-col items-center justify-center py-70 overflow-hidden'>
  ...
  <div className="container mx-auto px-4 relative z-10">
    ...
    <div className="relative h-[500px] mb-20">
      ...
      <div className="absolute left-0 top-0 w-[450px] rotate-[-8deg] shadow-2xl ">
        <Image src="/urbancity3..png" width={450} height={450} alt="Lifestyle" />
      </div>

      {/* Fotka v strede - vzadu */}
      <div className="absolute left-1/2 -translate-x-1/2 top-[-20px] w-[350px] rotate-[2deg] shadow-xl">
        <Image src="/urbancity..png" width={350} height={350} alt="City walk" />
      </div>

      {/* Fotka vpravo - náklon doprava */}
      <div className="absolute right-0 top-10 w-[350px] rotate-[3deg] shadow-2xl border-4 border-white">
        <Image src="/urbancity2.png" width={350} height={450} alt="Models" />
      </div>

      {/* KRÚŽOK S TEXTOM "Exkluzívne modely" */}
      <div className="absolute left-[55%] top-[60%] w-[400px]">
...
<div className="max-w-7xl relative mx-auto mt-50 px-6 pt-25">
