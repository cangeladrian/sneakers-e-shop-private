...
`}>
      ...
      <section className='flex flex-col items-center w-full h-[80vw] md:h-[15vw] bg-black justify-center'>


        <div className='relative '>
          <h2 className='font-normal mt-2 text-center text-white lg:text-[30px]'>Prihlás sa na odber noviniek a získaj
