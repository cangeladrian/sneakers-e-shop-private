...
<section className="bg-white pt-30 md:py-20">
    <div className='flex flex-col items-center justify-center  s px-6'>
      
   
     
      
      <div className="max-w-4xl mx-auto absolute z-50 text-center md:text-left">
        <HandwrittenNote text="Since 2012" className="text-lime-400 block mb-8 mx-auto" />
        <h2 className="text-xl uppercase text-white leading-tight  font-semibold text-center tracking-tighter leading-tight mb-12">
          DIVOKÁ RÝCHLOSŤ
        </h2>
       ...
       <div className=" z-0 w-full  aspect-video mb-12">
        <video
